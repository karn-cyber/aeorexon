...
import { cafeChairs, diningChairs, lynchpinLifestyle } from "@/data/lynchpin";
...
export const metadata = {
  ...
  description:
    "Lynchpin's full Café and Dining chair collections, supplied by Aorexon as a channel partner.",
};

const area = solutionBySlug["lynchpin-seating"];

export default function LynchpinPage() {
  const total = cafeChairs.length + diningChairs.length;
  ...
  return (
    <div>
      ...
      <LynchpinCatalog cafe={cafeChairs} dining={diningChairs} lifestyle={lynchpinLifestyle} />
